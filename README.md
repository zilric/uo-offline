...
- **Thieves pick pockets.** The Thief class had the skills and the dark leathers and never used them. A thief now works the crowd at banks, taverns and shop doors, walks up to a mark, peeks in the pack and lifts the best light thing in it, from bots and from you. It is the real Stealing skill, so the weight cap, the skill roll, the caught roll and the criminal flag are all the engine's. A caught thief runs and hides; caught next to a banker it dies to the guards in about a second, the same as 1999. Thieves bank the take, victims gossip about being robbed, and a bot that raises a flagged thief in town no longer gets whacked for it.
...
**Thieves pick pockets.** Thief-class bots are in the Thieves Guild and work the places people stand around with full packs: bank plazas, taverns, shop doors. One picks a mark, walks up, snoops the pack and steals the best light item with the real Stealing skill, so gold comes off in the amounts the skill allows and a magic weapon can walk off. Most thieves only rob marks standing away from the town NPCs, because a criminal flagged within eight tiles of one gets a guard on the spot. The bold ones gamble. A noticed thief runs, hides once it has a gap, and waits out the flag; the fighters nearby draw on it the way they draw on any gray. The haul goes into the bank box.
